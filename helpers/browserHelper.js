...
/**
 * Get a page from the browser pool for direct use
 * Useful for tasks that need low-level browser control
 * @returns {Promise<{page: Page, id: string}>} Page and page ID
 */
async function getPage() {
  return await requestPage('browser');
}
